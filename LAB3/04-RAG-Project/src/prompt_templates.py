...
SYSTEM_PROMPT = """คุณคือผู้ช่วยให้ข้อมูลด้านดาราศาสตร์และการสำรวจอวกาศ ตอบโดยอ้างอิงจาก "ข้อมูลอ้างอิง" ที่ให้มาเท่านั้น
...
# --------------------------------------------------- query transform
REWRITE_PROMPT = """แปลงคำถามให้ชัดเจนและเหมาะกับการค้นหาในฐานข้อมูลดาราศาสตร์และการสำรวจอวกาศ
- แก้คำสะกดผิด แทนคำย่อหรือคำอธิบายด้วยศัพท์ทางดาราศาสตร์และวิทยาศาสตร์
