# -*- coding: utf-8 -*-
# Load and parse astronomy_knowledge_base.txt into records shared by problem01-09.
import os
import re

DATA_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "astronomy_knowledge_base.txt")
...
if __name__ == "__main__":
    ...
    print("Categories:", categories(data))
    print("First entry:", data[0]["question"])
